...
angular.module('starter', ['ionic', 'starter.service'])

.run(function($ionicPlatform, NotificationPubSub, $ionicPopup) {
  $ionicPlatform.ready(function() {
        ...
        /***********************/
         ...
         var hardwareBackButtonHandler = function() {
            ...
            // NotificationPubSub.publish({ type:NotificationPubSub.notifyTypes().BACK_BUTTON, data:cancelRegisterBackButtonAction  });
         }
      ...
      //var cancelRegisterBackButtonAction = $ionicPlatform.registerBackButtonAction(hardwareBackButtonHandler, 100);
      var cancelRegisterBackButtonAction = $ionicPlatform.registerBackButtonAction($ionicPlatform.registerBackButtonAction(function(event) {
...
.controller('PopupCtrl',function($scope, $ionicPopup, $timeout, NotificationPubSub) {
